  ...
  return (
    <Card className="neon-border-accent">
      <CardHeader>
        ...
        <CardDescription>Enter your project details to get a custom estimate. Add or remove services as needed.</CardDescription>
      </CardHeader>
        ...
        {items.map((item, index) => (
          <div key={item.id} className="grid grid-cols-1 md:grid-cols-10 gap-2 items-end p-2 border rounded-md">
            <div className="md:col-span-4">
              ...
              <Input
                type="text"
                placeholder="e.g., Exterior Power Washing"
         ...
         <Button variant="outline" onClick={addNewItem}><PlusCircle className="mr-2" /> Add Service</Button>
      </CardContent>
